...
| Queue and history | Compact preview plus an optional item manager emit recall, cancel, discard, reorder, and dispatch-now intents; queue ownership and same-turn steering remain in the harness |
